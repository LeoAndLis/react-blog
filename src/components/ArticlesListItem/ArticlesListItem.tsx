    ...
    <header className="article__header">
      <div className="article__info-block">
        <div className="article__title-block">
          ...
          <button className="article__favorite-button" type="button">
          ...
          <span className="article__favorite-count">12</span>
        </div>
        <ul className="article__tags articles-tags">
          <li className="articles-tags__item">Tag1</li>
          <li className="articles-tags__item">Tag2</li>
        </ul>
      </div>
      <div className="article__author-block">
        <span className="article__author">John Doe</span>
